...
import { Newspaper, Calendar, ExternalLink, Search, Filter } from 'lucide-react';
...
const pressArticlesData = [
  {
    ...
    year: '2024',
    category: 'Actualité',
    image: 'https://images.unsplash.com/photo-1589998059171-988d887df646?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80',
  ...
  },
  {
    ...
    year: '2024',
    category: 'Cour d\'Assises',
    image: 'https://storage.googleapis.com/hostinger-horizons-assets-prod/a67cff5d-5256-450a-8724-54e03507ecf0/7cb061b9b55989b7c7abf2637e1f4cea.jpg',
  ...
  },
  {
    ...
    year: '2024',
    category: 'Justice',
    image: 'https://images.unsplash.com/photo-1521791136064-7986c2920216?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80',
...
const Presse = () => {
  ...
  const years = ['all', ...new Set(pressArticlesData.map(article => article.year))].sort((a, b) => (b === 'all' ? -1 : a === 'all' ? 1 : parseInt(b) - parseInt(a)));
              ...
              <div className="p-6 flex flex-col flex-grow">
                <div className="flex items-center justify-between mb-3">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-sm font-medium text-slate-600">{article.source}</span>
                  </div>
